...
class StiefelManifold:
    ...
    def __repr__(self):
        ...
        return "StiefelManifold(retraction={}, metric={})".format(
            self.retraction, self._metric
        )
    ...
    def retraction(self, u: jnp.ndarray, vec: jnp.ndarray) -> jnp.ndarray:
    ...
    def random(self, key: PRNGKey, shape: tuple, dtype=jnp.complex64) -> jnp.ndarray:
    ...
    def random_tangent(self, key, u: jnp.ndarray) -> jnp.ndarray:
    ...
    def is_in_manifold(self, u: jnp.ndarray, tol=1e-5) -> jnp.ndarray:
