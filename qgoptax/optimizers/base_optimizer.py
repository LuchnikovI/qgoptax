...
class Optimizer:
    ...
    def init(self,
        ...
        return (jnp.array(0, dtype=jnp.int32), *transpose_pytree(tree_map(self._create_state, params)))

    def update(self,
               grads: Params,
               state: Tuple[Params],
               params: Params) -> Tuple[Params, Tuple[Params]]:
        ...
        iter = state[0]
        params, state = transpose_pytree(tree_multimap(lambda x, z, *y: self._apply(iter, x, y, z), grads, params, *state[1:]))
